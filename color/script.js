<link rel="stylesheet" class="aplayer-secondary-style-marker" href="\assets\css\APlayer.min.css"><script src="\assets\js\APlayer.min.js" class="aplayer-secondary-script-marker"></script><script class="meting-secondary-script-marker" src="\assets\js\Meting.min.js"></script>var webgradients = [
    { 
        "style": {
...
new Vue({
  ...
  computed: {
    ...
    copyCSSText: function() {
      return (this.copyCSSResults != "") ? this.copyCSSResults : "复制 CSS";
    }
  },
  methods: {
    ...
    copyCSS: function() {
      ...
      if (navigator.clipboard != undefined) {
        navigator.clipboard.writeText(text).then(function() {
          _this.copyCSSResults = "已复制 !!!";
        }, function(err) {
          _this.copyCSSResults = "失败 :(";
        });
